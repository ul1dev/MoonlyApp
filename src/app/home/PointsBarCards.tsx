...
export default function PointsBarCards() {
    ...
    const boostsCountView = getShortFormatedBalance(String(data.boostsBalance));
    const coinsCountView = getShortFormatedBalance(data.coinsBalance);
    ...
    return (
        <>
                ...
                <div className="max-[680px]:px-6 max-[680px]:py-3 px-12 py-5 text-center relative z-[100] mb-1">
                    ...
                    <div
                        className={classNames(
                            'flex items-center max-[440px]:gap-[1.5px] max-[680px]:gap-[2px] gap-[3px]',
                            {
                                '-ml-1.5': boostsCountView.length < 3,
                                '-ml-1': boostsCountView.length === 3,
                            }
                        )}
                    >
            ...
            >
                ...
                <div className="max-[680px]:px-6 max-[680px]:py-3 px-12 py-5 text-center relative z-[100] mb-1">
                    <div className="text-white max-[680px]:text-2xl text-4xl font-black">
                        {getShortFormatedBalance(String(data.level))}
                    </div>
                    <div className="text-[#b1b1b1] max-[440px]:text-xs max-[680px]:text-sm text-base font-semibold">
                        {t('home.level')}
                    </div>
                ...
                <div className="max-[680px]:px-6 max-[680px]:py-3 px-12 py-5 text-center relative z-[100] mb-1">
                    ...
                    <div
                        className={classNames(
                            'flex items-center max-[440px]:gap-[1.5px] max-[680px]:gap-[2px] gap-[3px]',
                            {
                                '-ml-1.5': coinsCountView.length < 3,
                                '-ml-1': coinsCountView.length === 3,
                            }
                        )}
                    >
                        <PixelGreenCoinIcon
